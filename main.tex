...
\lstinputlisting[language={[x86masm]Assembler}, firstline=1, lastline=67, firstnumber=1, caption={Rutina del coprocesador ULP en ensamblador para sensado PIR pasivo (\texttt{pir\_monitor.S}).}, label=lst:ulp_assembly]{src/trapcam_mesh/main/ulp/pir_monitor.S}
