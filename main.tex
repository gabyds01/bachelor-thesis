...
\begin{figure}[htbp]
	\centering
	% \includegraphics[width=0.7\textwidth]{figures/diagrama-firmware-nodo.png}
...
\begin{table}[htbp]
	...
	\begin{tabular}{lc}
		...
		\hline
		Línea de vista directa      & [X] \unit{m}              \\
		Con obstáculos (vegetación) & [X] \unit{m}              \\
		Interior (paredes)          & [X] \unit{m}              \\
		\hline
	\end{tabular}
\end{table}
...
\begin{itemize}
	\item Capacidad del pack 2S: [X] \unit{mAh}
	\item Consumo promedio: [X] \unit{mA}
