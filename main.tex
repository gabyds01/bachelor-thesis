...
\textbf{Por tipo de sensor de activación:}
\begin{description}
...
\textbf{Por tipo de iluminación nocturna:}
\begin{description}
...
\begin{figure}[htbp]
	\centering
	\includegraphics[width=0.6\textwidth]{img/carcasaNodo.jpg}
